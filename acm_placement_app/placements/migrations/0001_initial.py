# Generated by Django 2.1.8 on 2019-05-27 19:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acm_survey_data_file', models.FileField(upload_to='data/inputs/acm_survey_data/', verbose_name='ACM survey data file')),
                ...
                ('commutes_reference_file', models.FileField(blank=True, help_text="After placements are made, you will find a 'Output_Commute_Reference.csv' file in the results. If you want to run additional placement processes, upload that file here to avoid commute calculation wait time and cost.", upload_to='documents/outputs')),
